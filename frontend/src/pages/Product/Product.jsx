    ...
    return (
        <div id="product" className="page">
            <div className="course">
                ...
                <img src={"http://localhost:1234/assets/images/" + item.coverImg} alt="subcourse cover" className="subcourse-img"></img>
                        ...
                        item.subcourses.map(subcourse=>{
                            return (
                                <div key={subcourse.id} className="subcourse">
                                    ...
                                    <img src={"http://localhost:1234/assets/images/" + subcourse.coverImg} alt="subcourse cover" className="subcourse-img"></img>
